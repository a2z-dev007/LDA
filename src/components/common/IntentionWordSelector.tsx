...
const styles = StyleSheet.create({
  container: { gap: 12 },
  label: {
    color: 'rgba(255,255,255,0.4)', fontSize: 12, fontFamily: 'Inter-SemiBold',
  ...
  pillText: { color: 'rgba(255,255,255,0.7)', fontSize: 14, fontFamily: 'Inter-SemiBold' },
  customRow: { flexDirection: 'row', gap: 8, alignItems: 'center' },
  customInput: {
    flex: 1, color: '#FFFFFF', fontSize: 15, fontFamily: 'Inter-Regular',
    borderWidth: 1.5, borderRadius: 12, paddingHorizontal: 14, paddingVertical: 10,
  },
  customBtn: {
    paddingHorizontal: 16, paddingVertical: 10, borderRadius: 12,
  },
  customBtnText: { color: colors.dark, fontSize: 14, fontFamily: 'Inter-SemiBold' },
